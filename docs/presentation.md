...
Live: produceyourstuff.up.railway.app · 46 commits · 311 tests
...
**Why it holds up.** 311 automated tests, none calling a live model. A 19-case behavioural eval, all passing, whose results table is machine-generated and refuses to publish while any case fails.
...
# SLIDE 11 — Evidence: 311 tests, 19/19 behavioural cases, and a machine-generated results table
