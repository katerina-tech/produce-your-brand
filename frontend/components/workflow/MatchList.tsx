  ...
  if (matches.length === 0) {
    return (
      <Notice tone="warning" title="No eligible partners">
        No partner in the dataset can perform this method for this product
        category. Try a different production method, or adjust the brief.
      </Notice>
    );
  }
  ...
  return (
    <Card>
      <CardHeader
        ...
        aside={<Badge>{matches.length} shown</Badge>}
      />
      {error ? (
